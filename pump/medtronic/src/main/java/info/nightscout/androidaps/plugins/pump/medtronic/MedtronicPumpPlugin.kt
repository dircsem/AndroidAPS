 ...
 */
@Singleton
open class MedtronicPumpPlugin @Inject constructor(
    ...
    override val serviceClass: Class<*> = RileyLinkMedtronicService.javaClass
//TODO this has break the medtronic impl
    override val pumpStatusData: MedLinkPumpStatus get() = MedLinkPartialBolus(pumpType)
