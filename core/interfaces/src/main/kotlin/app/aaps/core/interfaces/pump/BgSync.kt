...
interface BgSync {
    ...
    enum class GlucoseUnit {
        ...
        fun toDbType(): app.aaps.database.entities.data.GlucoseUnit =
            when(this){
                MGDL -> app.aaps.database.entities.data.GlucoseUnit.MGDL
                MMOL -> app.aaps.database.entities.data.GlucoseUnit.MMOL
        }
    }
